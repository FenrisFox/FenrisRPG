...
public class ItemInit {
    ...
    public static final RegistryObject<Item>
        ...
        CORE_VESSEL_BOOTS = addItem("core_vessel_boots", new CoreVesselItem()),
        CORE_VESSEL_SWORD = addItem("core_vessel_sword", new CoreVesselItem()),
        CORE_VESSEL_PICKAXE = addItem("core_vessel_pickaxe", new CoreVesselItem()),
        CORE_VESSEL_AXE = addItem("core_vessel_axe", new CoreVesselItem()),
        CORE_VESSEL_SHOVEL = addItem("core_vessel_shovel", new CoreVesselItem()),
        CORE_VESSEL_HOE = addItem("core_vessel_hoe", new CoreVesselItem()),
        CORE_VESSEL_HAMMER = addItem("core_vessel_hammer", new CoreVesselItem()),
        CORE_VESSEL_KATANA = addItem("core_vessel_katana", new CoreVesselItem()),
        CORE_VESSEL_DAGGER = addItem("core_vessel_dagger", new CoreVesselItem()),
        CORE_VESSEL_BROADSWORD = addItem("core_vessel_broadsword", new CoreVesselItem()),
