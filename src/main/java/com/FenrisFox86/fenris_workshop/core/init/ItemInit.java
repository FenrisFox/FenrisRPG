...
public class ItemInit {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, FenrisWorkshop.MOD_ID);
    public static Map<String, Item> ITEM_MAP = new HashMap<>();

    static Item.Properties ItemTabProps() {
        return new Item.Properties().tab(FenrisWorkshop.MOD_TAB);
    }
    ...
    public static Map<String, RegistryObject<Item>> addToolSet(String name, IItemTier tier) {
        ...
        MAP.put("SWORD", addItem(name + "_sword", new SwordItem(
                tier, 2, -1.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("AXE", addItem(name + "_axe", new AxeItem(
                tier, 3, -2.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("PICKAXE", addItem(name + "_pickaxe", new PickaxeItem(
                tier, 2, -2.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("SHOVEL", addItem(name + "_shovel", new ShovelItem(
                tier, 1, -2.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("HOE", addItem(name + "_hoe", new HoeItem(
                tier, 0, -2.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
    ...
    public static Map<String, RegistryObject<Item>> completeToolSet(String name, IItemTier tier, @Nullable Map map) {
        ...
        MAP.put("HAMMER", addItem(name+ "_hammer", new HammerItem(
                tier, 4, -1.5F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("DAGGER", addItem(name+ "_dagger", new SingleHandedSwordItem(
                tier, 0, -1.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("KATANA", addItem(name+ "_katana", new SingleHandedSwordItem(
                tier, 2, -1.5F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("BROADSWORD", addItem(name+ "_broadsword", new BroadswordItem(
                tier, 6, -3.0F, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
    ...
    public static Map<String, RegistryObject<Item>> addArmorSet(String name, IArmorMaterial material) {
        ...
        MAP.put("HELMET", addItem(name + "_helmet", new ArmorItem(
                material, EquipmentSlotType.HEAD, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("CHESTPLATE", addItem(name + "_chestplate", new ArmorItem(
                material, EquipmentSlotType.CHEST, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("LEGGINGS", addItem(name + "_leggings", new ArmorItem(
                material, EquipmentSlotType.LEGS, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        MAP.put("BOOTS", addItem(name + "_boots", new ArmorItem(
                material, EquipmentSlotType.FEET, new Item.Properties().tab(FenrisWorkshop.MOD_TAB))));
        return MAP;
    }
    ...
    public static final RegistryObject<Item>
        ...
        CORE_VESSEL_HELMET = addItem("core_vessel_helmet", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_CHESTPLATE = addItem("core_vessel_chestplate", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_LEGGINGS = addItem("core_vessel_leggings", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_BOOTS = addItem("core_vessel_boots", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_SWORD = addItem("core_vessel_sword", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_PICKAXE = addItem("core_vessel_pickaxe", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_AXE = addItem("core_vessel_axe", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_SHOVEL = addItem("core_vessel_shovel", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_HOE = addItem("core_vessel_hoe", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_HAMMER = addItem("core_vessel_hammer", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_KATANA = addItem("core_vessel_katana", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_DAGGER = addItem("core_vessel_dagger", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
        CORE_VESSEL_BROADSWORD = addItem("core_vessel_broadsword", new DescriptionItemBase("tooltip.fenris_workshop.core_vessel_items.lore", "tooltip.fenris_workshop.core_vessel_items.desc")),
